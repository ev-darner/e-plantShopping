                    ...
                    <div key={index}> {/* Unique key for each category div */}
                        ...
                        <div className='product-list'> {/* Container for the list of plant cards */}
                            {category.plants.map((plant, plantIndex) => ( 
                                ...
                                <button className={`product-button ${addedToCart[plant.name] ? 'added-to-cart' : ''}`} onClick={() => handleAddToCart(plant)} disabled={addedToCart[plant.name]}>{addedToCart[plant.name] ? "Added to Cart" : "Add to Cart"}</button> {/* Handle adding plant to cart */}
                                </div> 
                            ))}
                        </div>
                    </div>
